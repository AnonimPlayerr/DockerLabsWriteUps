...
Hacemos un escaneo de subdominios a ver que encontramos: 
...
Mirando que más podía hacer mire el codigo fuente de la página apache "http://172.17.0.2/":
...
Encontre este código y lo busque en google para ver que podría ser:
...
Podemos ver que es un código "Brainfuck".
Lo traducimos y nos da esto:
...
Entramos en el servidor ssh con el usuario "agua" y la contraseña "bebeaguaqueessano":
...
Probamos a ver si podemos escalar privilegios:
...
Ejecutamos el binario como sudo:
...
Ejecutamos help para ver que comandos podemos hacer y vemos este:
